 ...
 * Hauptspeicherzuteilung pro Prozess.
 * 
...
public class SimulationEnv {
	...
	public static void main(String[] args) {
		...
		System.out.println("*********** Simulation der Betriebssystem-Speicherverwaltung wurde nach " + simulationTime
				+ " ms beendet *************");
